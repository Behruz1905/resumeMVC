<?php
		...
		if($_SESSION['usertype'] == "seller") {
			$cpath = "../../../../../../content_img/sellers/".$_SESSION['folder'];
		} else if($_SESSION['usertype'] == "moderator") {
			$cpath = "../../../../../../content_img/news";
		} else {
			$cpath = "../../../../../../content_img/";
		}
        ...
        $mcImageManagerConfig['filesystem.path'] = $cpath; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $cpath; // absolute or relative from this script path, required.

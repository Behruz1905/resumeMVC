<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../../content_files/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../../content_files/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,mp3,png,pdf,zip,swf,doc,docx,xls,xlsx";
        ...
        $mcFileManagerConfig['log.path'] = '../../../../upload-files/';
